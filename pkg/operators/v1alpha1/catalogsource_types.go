...
// Function to check if the address is IPv6
func isIPv6Address(address string) bool {
	ip := net.ParseIP(address)
	return ip != nil && ip.To4() == nil // IPv6 addresses return nil for To4()
}

func (s *RegistryServiceStatus) Address() string {
	// Check if ServiceName is an IPv6 address
	if isIPv6Address(s.ServiceName) {
